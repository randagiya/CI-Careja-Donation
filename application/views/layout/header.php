  ...
  <aside
    ...
    <div class="sidenav-header ">
      ...
      <a class="navbar-brand m-0" href="https://pcr.ac.id/" target="_blank">
        <img src="<?= base_url('assets/') ?>img/pcr_logo.png" class="navbar-brand-img h-100 rounded-pill"
          alt="main_logo">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?= site_url('Post') ?>">
              <div
                class="icon icon-shape icon-lg border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?= site_url('Post/list') ?>">
              <div
                class="icon icon-shape icon-lg border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?= site_url('Post/akun') ?>">
              <div
                class="icon icon-shape icon-lg border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " target="_blank"
              href="https://www.instagram.com/bempcr/">
              <div
                class="icon icon-shape icon-lg border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <ul class="navbar-nav  justify-content-start">
            ...
            if ($user['role'] == 'User') {
              ...
              <li class="nav-item dropdown pe-4 px-4 d-flex align-items-center">
                <a href="<?= site_url('User/riyawat') ?>" class="nav-link text-white p-0" aria-expanded="false">
