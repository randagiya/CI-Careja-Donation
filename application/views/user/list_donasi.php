                                ...
                                <div class="container-fluid">
                                    ...
                                    <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li><a class="dropdown-item" href="<?= base_url('User/list') ?>">Terbaru</a></li>
                                            <li><a class="dropdown-item" href="<?= base_url('User/list_terlama')?>">Terlama</a></li>
                                            <li><a class="dropdown-item" href="<?= base_url('User/list_all')?>">Semua Terbaru</a></li>
                                            <li><a class="dropdown-item" href="<?= base_url('User/list_all_terlama') ?>">Semua Terlama</a></li>
                                        </ul>
                                    </div>
                                    <div class="btn-group" role="group">
                                    <form class="d-flex" method="post" action="<?= base_url('User/pencarian') ?>">
